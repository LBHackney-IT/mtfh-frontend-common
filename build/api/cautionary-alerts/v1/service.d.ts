...
export declare const useCautionaryAlert: (
  id: string | null,
  options?: AxiosSWRConfiguration<any>,
) => AxiosSWRResponse<CautionaryAlert>;
export declare const useCautionaryAlertByAlertId: (
  alertId: string,
  options?: AxiosSWRConfiguration<any>,
) => AxiosSWRResponse<CautionaryAlert>;
export declare const usePropertyCautionaryAlert: (
  propertyRef: string | null,
  options?: AxiosSWRConfiguration<any>,
) => AxiosSWRResponse<CautionaryAlert>;
export declare const getPropertyCautionaryAlerts: (
  assetId: string,
) => Promise<CautionaryAlert>;
