...
export declare const Table: React.ForwardRefExoticComponent<
  Pick<
    React.DetailedHTMLProps<
      ...
      HTMLTableElement
    >,
    "key" | keyof React.TableHTMLAttributes<HTMLTableElement>
  > &
...
export declare const Tr: React.ForwardRefExoticComponent<
  Pick<
    React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLTableRowElement>,
      HTMLTableRowElement
    >,
    "key" | keyof React.HTMLAttributes<HTMLTableRowElement>
  > &
...
export declare const Th: React.ForwardRefExoticComponent<
  ThProps & React.RefAttributes<HTMLTableHeaderCellElement>
>;
export interface TdProps extends ComponentPropsWithoutRef<"td"> {
  isNumeric?: boolean;
}
export declare const Td: React.ForwardRefExoticComponent<
  TdProps & React.RefAttributes<HTMLTableCellElement>
>;
