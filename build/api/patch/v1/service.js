...
exports.replacePatchResponsibleEntities =
  exports.deletePatchesAndAreasResponsibilities =
  exports.addResponsibleEntityToPatch =
  exports.getByPatchName =
  exports.usePatchOrArea =
  exports.getAllPatchesAndAreas =
    void 0;
...
const usePatchOrArea = (patchId, options) => {
  return (0, http_1.useAxiosSWR)(
    `${config_1.config.patchesAndAreasApiUrlV1}/patch/${patchId}`,
    options,
  );
};
...
const getByPatchName = async (patchName) => {
  return http_1.axiosInstance.get(
    `${config_1.config.patchesAndAreasApiUrlV1}/patch/patchName/${patchName}`,
  );
};
exports.getByPatchName = getByPatchName;
const addResponsibleEntityToPatch = async (
  patchId,
  responsibleEntityId,
  request,
  patchVersion,
...
const deletePatchesAndAreasResponsibilities = async (patchId, responsibleEntityId) => {
  await http_1.axiosInstance.delete(
    `${config_1.config.patchesAndAreasApiUrlV1}/patch/${patchId}/responsibleEntity/${responsibleEntityId}`,
  );
};
