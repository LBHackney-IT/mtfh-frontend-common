...
const useComments = (id, pageSize = 5) => {
    return (0, http_1.useAxiosSWRInfinite)((page, previous) => {
        var _a;
        if (previous && !((_a = previous === null || previous === void 0 ? void 0 : previous.paginationDetails) === null || _a === void 0 ? void 0 : _a.nextToken)) {
            return null;
        }
        const params = {
            targetId: id,
        ...
        return `${config_1.config.notesApiUrlV1}/notes?${(0, query_string_1.stringify)(params)}`;
    });
};
exports.useComments = useComments;
const addComment = async (data) => {
    const auth = auth_1.$auth.getValue();
    const { data: comment } = await http_1.axiosInstance.post(`${config_1.config.notesApiUrlV1}/notes`, {
        ...data,
