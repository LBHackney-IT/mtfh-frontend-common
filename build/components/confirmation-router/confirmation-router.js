...
const ConfirmationRouter = ({ children, ...props }) => {
    ...
    const onConfirmation = (0, react_1.useCallback)((ok) => {
        /* istanbul ignore else: this should be set by the time we call it */
        if (confirmation) {
            confirmation(ok);
        }
        if (!ok && (message === null || message === void 0 ? void 0 : message.action) === "POP") {
    ...
    return (react_1.default.createElement(react_router_dom_1.BrowserRouter, { getUserConfirmation: getUserConfirmation, ...props },
        react_1.default.createElement(scroll_to_top_1.ScrollToTop, null),
        children,
        react_1.default.createElement(confirmation_router_message_1.ConfirmationRouterMessage, { message: message, onConfirmation: onConfirmation, isConfirm: isConfirm })));
};
