...
exports.getFeatureToggle =
  exports.getConfigItem =
  exports.getConfiguration =
  exports.$configuration =
  exports.hydrateConfiguration =
    void 0;
...
const getConfiguration = async () => {
  try {
    const res = await http_1.axiosInstance.get(
      `${config_1.config.configurationApiUrlV1}/api/v1/configuration?types=MMH`,
    );
    ...
    window.localStorage.setItem(
      "features",
      JSON.stringify(exports.$configuration.getValue()),
    );
  } catch (e) {
...
const getFeatureToggle = (path) => {
  ...
  const appConfig = getAppConfig(type);
  const value =
    appConfig === null || appConfig === void 0 ? void 0 : appConfig.featureToggles[key];
