...
exports.TextArea = (0, react_1.forwardRef)(function TextArea(
  ...
  const [characterCount, setCharacterCount] = (0, react_1.useState)(
    getLengthOfValue(initialValue),
  );
  const onChangeHandler = (0, react_1.useCallback)(
    (event) => {
      var _a;
      if (
        ((_a = event === null || event === void 0 ? void 0 : event.currentTarget) ===
          null || _a === void 0
          ? void 0
          : _a.value) !== undefined &&
        !isControlled &&
  ...
  const messageClasses = (0, classnames_1.default)(
  ...
  return react_1.default.createElement(
    ...
    maxLength !== undefined &&
      ...
      react_1.default.createElement(
        "span",
        { className: messageClasses, "aria-live": "polite" },
        exceedingValue >= 0
          ? `You have ${exceedingValue} ${(0, utils_1.pluralize)(
              "character",
              exceedingValue,
            )} remaining`
          : `You have ${Math.abs(exceedingValue)} ${(0, utils_1.pluralize)(
              "character",
              exceedingValue,
            )} too many`,
      ),
