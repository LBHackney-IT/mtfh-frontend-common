...
export declare const useEqualityInformation: (
  targetId: string,
  options?: AxiosSWRConfiguration<EqualityData>,
) => AxiosSWRResponse<EqualityData>;
export declare const useEqualityInformationById: (
  id: string,
  targetId: string,
  options?: AxiosSWRConfiguration<EqualityData>,
) => AxiosSWRResponse<EqualityData>;
export declare const addEqualityInformation: (
  data: Omit<EqualityData, "id">,
) => Promise<import("axios").AxiosResponse<any, any, {}>>;
export declare const updateEqualityInformation: (
  id: string,
  data: Omit<EqualityData, "id">,
) => Promise<import("axios").AxiosResponse<any, any, {}>>;
