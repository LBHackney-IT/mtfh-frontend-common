export declare type PersonType = "Tenant" | "Leaseholder" | "Freeholder" | "HouseholdMember";
export declare enum PersonTitle {
    MR = "Mr",
    MRS = "Mrs",
    MISS = "Miss",
    MS = "Ms",
...
export declare enum PersonCommunincationRequirements {
