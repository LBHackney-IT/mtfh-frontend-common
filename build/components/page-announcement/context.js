...
exports.PageAnnouncementProvider = exports.usePageAnnouncement = exports.PageAnnouncementContext = void 0;
...
const usePageAnnouncement = () => {
    ...
    if (!context) {
        ...
        (_a = Error.captureStackTrace) === null || _a === void 0 ? void 0 : _a.call(Error, error, exports.usePageAnnouncement);
        throw error;
    }
    const { state, dispatch } = context;
    const addAnnouncement = (0, react_1.useCallback)((props) => {
...
const PageAnnouncementProvider = ({ sessionKey, children, }) => {
    ...
    return (react_1.default.createElement(exports.PageAnnouncementContext.Provider, { value: value }, children));
};
