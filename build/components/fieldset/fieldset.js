...
require("./styles.scss");
exports.Fieldset = (0, react_1.forwardRef)(function Fieldset(
  {
    variant = "base",
    indent = false,
    error,
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      "legend",
      {
        className: (0, classnames_1.default)("govuk-fieldset__legend", {
    ...
    react_1.default.createElement(
      "div",
      { className: (0, classnames_1.default)("mtfh-fieldset__content") },
      error &&
        react_1.default.createElement(
          "span",
          { className: "govuk-error-message lbh-error-message", "aria-hidden": "true" },
          error,
        ),
      children,
    ),
