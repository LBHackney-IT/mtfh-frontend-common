...
export declare const usePatchOrArea: (
  patchId: string,
...
export declare const addResponsibleEntityToPatch: (
  patchId: string,
  responsibleEntityId: string,
  request: UpdatePatchesAndAreasRequest,
  patchVersion: string | null,
) => Promise<AxiosResponse<any, any, {}>>;
export declare const deletePatchesAndAreasResponsibilities: (
  patchId: string,
  responsibleEntityId: string,
) => Promise<void>;
/**
 ...
 */
export declare const replacePatchResponsibleEntities: (
  patchId: string,
