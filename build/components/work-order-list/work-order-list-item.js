...
const WorkOrderListItem = ({ workOrder: { dateRaised, priority, tradeDescription, status, description, reference }, }) => {
    const { components } = locale_1.default;
    const dateRaisedAt = (0, react_1.useMemo)(() => (0, utils_1.formatDate)(dateRaised), [dateRaised]);
    const rows = [
        { value: dateRaisedAt, label: components.workOrderList.raisedAt },
        { value: priority, label: components.workOrderList.priority },
    ];
    return (react_1.default.createElement(link_box_1.LinkBox, null,
        react_1.default.createElement(card_1.Card, null,
            react_1.default.createElement(link_box_1.LinkOverlay, null,
                react_1.default.createElement(link_1.Link, { className: "lbh-link", isExternal: true, href: `${config_1.config.repairsHubAppUrl}/work-orders/${reference}` },
            ...
            react_1.default.createElement("div", { className: "work-order-list-item__status" },
                " ",
                status))));
};
