...
const CommentListItem = ({
  ...
  const createdAtDate = (0, react_1.useMemo)(
    () => (0, utils_1.formatDate)(createdAt),
    [createdAt],
  );
  const createdAtTime = (0, react_1.useMemo)(
    () => (0, utils_1.formatTime)(createdAt),
    [createdAt],
  );
    ...
    react_1.default.createElement(
      ...
      title &&
        react_1.default.createElement(
          "div",
          {
            className: (0, classnames_1.default)("comment__title", {
              "--highlight": highlight,
            }),
          },
          title,
        ),
      (categorisation === null || categorisation === void 0
        ? void 0
