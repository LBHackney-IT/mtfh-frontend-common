...
exports.axiosInstance.interceptors.request.use((reqConfig) => {
    ...
    const headers = (_a = axios_1.AxiosHeaders.from(reqConfig.headers)) !== null && _a !== void 0 ? _a : new axios_1.AxiosHeaders();
    ...
    if (reqConfig.method === "patch" && (data === null || data === void 0 ? void 0 : data.etag)) {
...
exports.axiosInstance.interceptors.response.use((res) => {
    var _a;
