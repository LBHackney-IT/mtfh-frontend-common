...
export declare const useContactDetails: (
  id: string,
  options?: AxiosSWRConfiguration<ContactDetailsResponse>,
) => AxiosSWRResponse<ContactDetailsResponse>;
export declare const addContactDetail: (
  id: string,
  data: ContactInformation,
) => Promise<ContactDetail>;
export declare const patchContactDetails: (
  contactId: string,
  personId: string,
  data: ContactInformation,
) => Promise<ContactDetail>;
export declare const addEmailContact: (
  id: string,
  email: string,
  description?: string,
) => Promise<ContactDetail>;
...
export declare const addCorrespondenceAddress: ({
  id,
  addressLine1,
  addressLine2,
  addressLine3,
