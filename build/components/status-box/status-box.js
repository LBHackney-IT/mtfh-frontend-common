...
require("./styles.scss");
exports.StatusBox = (0, react_1.forwardRef)(function StatusBox({ children, className, title, variant, ...props }, ref) {
    ...
    return (react_1.default.createElement(box_1.Box, { variant: variant },
        react_1.default.createElement("div", { ref: ref, className: "mtfh-status-box", ...props },
            icon,
            react_1.default.createElement("div", null,
                react_1.default.createElement("div", { className: "mtfh-status-heading__title" },
