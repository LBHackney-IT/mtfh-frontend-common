...
const NoComments = () => {
  return react_1.default.createElement(
    text_1.Text,
    { size: "sm" },
    locale_1.default.components.commentList.noCommentsAdded,
  );
};
const CommentList = ({ targetId }) => {
  ...
  return react_1.default.createElement(
    ...
    comments.map((comment) =>
      react_1.default.createElement(comment_list_item_1.CommentListItem, {
    ...
    (size > 1 || nextToken) &&
      react_1.default.createElement(
        simple_pagination_1.SimplePagination,
        null,
        size !== 1 &&
          react_1.default.createElement(
            simple_pagination_1.SimplePaginationButton,
            { variant: "previous", onClick: () => setSize(size - 1) },
            "Previous",
          ),
        nextToken &&
          react_1.default.createElement(
            simple_pagination_1.SimplePaginationButton,
            { variant: "next", onClick: () => setSize(size + 1) },
            "Next",
          ),
      ),
  );
