...
exports.useBreakpointValue = exports.useBreakpoint = exports.queries = exports.BREAKPOINTS = void 0;
...
const useBreakpoint = (breakpoint, defaultBreakpoint) => {
    const { minWidth } = (0, use_breakpoint_1.default)(exports.BREAKPOINTS, defaultBreakpoint);
...
const useBreakpointValue = (breakpointRecord, defaultBreakpoint) => {
    const { minWidth, breakpoint } = (0, use_breakpoint_1.default)(exports.BREAKPOINTS, defaultBreakpoint);
