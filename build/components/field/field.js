...
const Field = ({ id, label, children, name, type, ...props }) => {
  const [field, meta] = (0, formik_1.useField)({
    name,
    type,
  ...
  return react_1.default.createElement(
    ...
    { as: comp, id: id, label: label, error: meta.error, ...props },
    (0, react_1.cloneElement)(children, { ...field }),
  );
};
exports.Field = Field;
...
const DateField = ({
  ...
  return react_1.default.createElement(
    form_group_1.FormGroup,
    { as: "fieldset", error: error, ...props },
    react_1.default.createElement(date_input_1.DateInput, {
...
const TimeField = ({
  ...
  return react_1.default.createElement(
    form_group_1.FormGroup,
    { as: "fieldset", error: error, ...props },
    react_1.default.createElement(time_input_1.TimeInput, {
