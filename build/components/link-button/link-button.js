...
require("./styles.scss");
exports.LinkButton = (0, react_1.forwardRef)(function LinkButton({ variant = "link", className, children, ...props }, ref) {
    ...
    return (react_1.default.createElement("button", { ref: ref, className: linkClasses, type: "button", ...props }, children));
});
