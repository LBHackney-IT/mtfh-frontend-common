...
exports.Table = (0, react_1.forwardRef)(function Thead({ className, ...props }, ref) {
  return react_1.default.createElement("table", {
    ref: ref,
    className: (0, classnames_1.default)("govuk-table", "lbh-table", className),
    ...props,
  });
});
exports.Thead = (0, react_1.forwardRef)(function Thead({ className, ...props }, ref) {
  return react_1.default.createElement("thead", {
    ref: ref,
    className: (0, classnames_1.default)("govuk-table__head", className),
    ...props,
  });
});
exports.Tbody = (0, react_1.forwardRef)(function Tbody({ className, ...props }, ref) {
  return react_1.default.createElement("tbody", {
    ref: ref,
    className: (0, classnames_1.default)("govuk-table__body", className),
    ...props,
  });
});
exports.Tr = (0, react_1.forwardRef)(function Tr({ className, ...props }, ref) {
  return react_1.default.createElement("tr", {
    ref: ref,
    className: (0, classnames_1.default)("govuk-table__row", className),
    ...props,
  });
});
exports.Th = (0, react_1.forwardRef)(function Th(
  { className, isNumeric, ...props },
  ref,
) {
  const thClasses = (0, classnames_1.default)(
    "govuk-table__cell",
    "govuk-table__header",
    {
...
exports.Td = (0, react_1.forwardRef)(function Td(
  { className, isNumeric, ...props },
  ref,
) {
  const tdClasses = (0, classnames_1.default)(
    "govuk-table__cell",
    {
      "govuk-table__cell--numeric": isNumeric,
    },
...
exports.TableCaption = (0, react_1.forwardRef)(function TableCaption(
  { children, className, variant, ...props },
  ref,
) {
  const captionClasses = (0, classnames_1.default)(
  ...
  return react_1.default.createElement(
    "caption",
    { ref: ref, className: captionClasses, ...props },
    children,
  );
});
