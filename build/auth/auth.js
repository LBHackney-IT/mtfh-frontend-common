...
exports.cognitoLogin =
  exports.getCognitoTokenCookieSetOptions =
  exports.login =
  exports.logout =
  exports.getAuthCookieRemoveOptions =
  exports.isAuthorised =
  exports.isAuthorisedForGroups =
  exports.parseToken =
  exports.$auth =
  exports.verifyCognitoToken =
  exports.voidUser =
  exports.TokenExchangeError =
  exports.TokenSource =
...
const parseToken = async () => {
    ...
    try {
      ...
      const customGroups =
        source === TokenSource.CognitoUser
          ? (_a = decoded["custom:groups"]) === null || _a === void 0
            ? void 0
  ...
  if (!legacyToken && !cognitoToken) {
    ...
    if (
      (auth === null || auth === void 0 ? void 0 : auth.email) !== "" &&
      (auth === null || auth === void 0 ? void 0 : auth.name) !== ""
    ) {
...
const isAuthorisedForGroups = (featureGroups) => {
  ...
  return featureGroups.some((fg) =>
    userGroups === null || userGroups === void 0 ? void 0 : userGroups.includes(fg),
  );
};
exports.isAuthorisedForGroups = isAuthorisedForGroups;
const isAuthorised = () =>
  (0, exports.isAuthorisedForGroups)(config_1.config.authAllowedGroups);
...
const login = (redirectUrl = `${exports.browserLocation.getOrigin()}/search`) => {
  (0, exports.logout)();
  exports.browserLocation.setHref(
    `${config_1.config.authDomain}?redirect_uri=${encodeURIComponent(redirectUrl)}`,
  );
};
exports.login = login;
...
const cognitoLogin = async (redirectUrl = `${exports.browserLocation.getOrigin()}`) => {
  ...
  sessionStorage.setItem(
    config_1.config.cognitoPKCEVerifierSessionStorageName,
    codeVerifier,
  );
...
async function handleCognitoCallback(code) {
  ...
  try {
    ...
    js_cookie_1.default.set(
      config_1.config.cognitoTokenName,
      tokens.id_token,
      (0, exports.getCognitoTokenCookieSetOptions)(getCookieExpiry(decodedIdToken)),
    );
  } catch {
