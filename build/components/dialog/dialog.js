...
require("./styles.scss");
exports.Dialog = (0, react_1.forwardRef)(function Dialog(
  ...
  return react_1.default.createElement(
    dialog_1.Dialog,
    {
      ...
      isOpen: isOpen,
      onDismiss: onDismiss,
      className: (0, classnames_1.default)("lbh-dialog", className),
      "aria-label": title,
      ...props,
    },
    react_1.default.createElement(
      heading_1.Heading,
      { as: "h2", variant: "h2", className: "lbh-dialog__title" },
      title,
    ),
    react_1.default.createElement(
      "button",
      { type: "button", onClick: onDismiss, className: "lbh-dialog__close" },
      react_1.default.createElement(
        "span",
...
exports.DialogActions = (0, react_1.forwardRef)(function DialogActions(
  { className, ...props },
  ref,
) {
  return react_1.default.createElement("div", {
    ref: ref,
    className: (0, classnames_1.default)("lbh-dialog__actions", className),
    ...props,
  });
});
