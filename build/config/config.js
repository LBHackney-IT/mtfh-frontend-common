...
function parseCognitoClientIds() {
...
const config = {
    ...
    housingFinanceInterimApiUrlV1: process.env.HOUSING_FINANCE_INTERIM_API_URL_V1 || "/api/v1",
    ...
    cognitoPKCEVerifierSessionStorageName: process.env.COGNITO_PKCE_VERIFIER_SESSION_STORAGE_NAME ||
